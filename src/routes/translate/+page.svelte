...
<div class="fixed z-10 { shift? '' : 'sm:translate-x-[-10vw] translate-x-[-25vw]' } sm:w-[10vw] w-[25vw] h-dscreen bg-gray-600">
    ...
    <div class="grid place-content-center w-full">
        {#if innerWidth > innerHeight}
            <button class="bg-gray-500 hover:bg-gray-700 w-[9vw] py-1 rounded text-center mb-2" on:click={go_home}>
                Home
            </button>
            <button class="bg-gray-500 hover:bg-gray-700 w-[9vw] py-1 rounded text-center mb-2" on:click={clear_history}>
                Clear
            </button>
        {:else}
            <button class="bg-gray-500 hover:bg-gray-700 sm:w-[9vw] w-[24vw] py-1 rounded flex place-content-center sm:mb-5 mb-2" on:click={go_home}>
            ...
            <button class="bg-gray-500 hover:bg-gray-700 sm:w-[9vw] w-[24vw] py-1 rounded flex place-content-center sm:mb-5 mb-2" on:click={clear_history}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 stroke-black">
